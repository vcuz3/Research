...
strategy on GC (COMEX Gold). Faithful port of the NQ/ES baseline runner. Establishes
...
Usage: python -m futures.gc.noise_vwap.scripts.run_baseline GC 90
"""
...
def main():
    ...
    outdir = "futures/gc/noise_vwap/outputs"
    import os
