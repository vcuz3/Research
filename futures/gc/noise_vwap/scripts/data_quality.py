"""
Data-quality gate for the GC Noise-Area + VWAP baseline (RULES.md rule 9a).
...
RTH 1-min GC data and the same-time-of-day noise band:
...
Reproduce the report:  python -m futures.gc.noise_vwap.scripts.data_quality GC 90
"""
