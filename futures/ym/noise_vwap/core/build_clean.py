"""
Build a clean 1-minute parquet dataset for YM (E-mini Dow, CBOT) from the
...
We use the RAW (unadjusted continuous, YM.v.0) file, not a back-adjusted one:
...
Written to futures/ym/data/YM_1m_clean.parquet
Run:  python -m futures.ym.noise_vwap.core.build_clean
"""
...
# parents[3] = futures (DB source); parents[2] = futures/ym (shared instrument data,
...
RAW = {
    "YM": DB / "YM_ohlcv-1m_YMv0_20100606_20260718.parquet",
}
