...
strategy on YM (E-mini Dow). Faithful port of the NQ/ES baseline runner. Establishes
...
Usage: python -m futures.ym.noise_vwap.scripts.run_baseline YM 90
"""
...
def main():
    ...
    outdir = "futures/ym/noise_vwap/outputs"
    import os
