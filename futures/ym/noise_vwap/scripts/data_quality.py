"""
Data-quality gate for the YM Noise-Area + VWAP baseline (RULES.md rule 9a).
...
RTH 1-min YM data and the same-time-of-day noise band:
...
Reproduce the report:  python -m futures.ym.noise_vwap.scripts.data_quality YM 90
"""
...
def main() -> None:
    inst = sys.argv[1] if len(sys.argv) > 1 else "YM"
